  ...
  return (
    <div>
      ...
      <ul className="flex sm:gap-8 text-lg justify-center pt-3 sm:pt-8 text-center  sm:pr-80 fixed z-50 bg-white w-screen ">
        ...
        />
        <li>
        <NavLink to="/" className='iborder hidden sm:iborder sm:block'>Home</NavLink>

        </li>
        <li>
          <NavLink to="/about"  className='iborder hidden sm:iborder sm:block'>About</NavLink>
        </li>
        <li>
          <NavLink to="/contact" className='iborder hidden sm:block sm:iborder' >Contact</NavLink>
        </li>
