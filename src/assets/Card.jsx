...
class CardCarousel extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <button onClick={this.handleLeftArrowClick} className="relative top-36 sm:pl-32 text-gray-300 "><i class="fa-solid fa-angles-left fa-2xl"></i></button>
        <button onClick={this.handleRightArrowClick} className="relative top-36 left-80 sm:pl-96 sm:ml-96 text-gray-300"><i class="fa-solid fa-angles-left fa-rotate-180 fa-2xl"></i></button>
        <div>
